...
INSERT INTO account (email, name, password) VALUES ('manager@email.com', '매니저', '{noop}password');
INSERT INTO account_roles (account_id, role_id) VALUES (2, 2);
INSERT INTO account_roles (account_id, role_id) VALUES (2, 3);
INSERT INTO account (email, name, password) VALUES ('admin@email.com', '관리자', '{noop}password');
