...
INSERT INTO account (username, email, name, password, phone, joinedAt) VALUES ('admin', 'admin@email.com', '관리자', '{noop}password', '010-1234-0000', CURRENT_TIMESTAMP);
INSERT INTO account (username, email, name, password, phone, joinedAt) VALUES ('manager', 'manager@email.com', '매니저', '{noop}password', '010-1234-9999', CURRENT_TIMESTAMP);
INSERT INTO account (username, email, name, password, phone, joinedAt) VALUES ('user', 'user@email.com', '사용자', '{noop}password', '010-1234-1111', CURRENT_TIMESTAMP);
